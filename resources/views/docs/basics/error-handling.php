<article>
	...
	<p>All exceptions are handled by the <code class=" language-php">App\<span class="token package">Exceptions<span class="token punctuation">\</span>Handler</span></code> class. This class contains two methods: <code class=" language-php">report</code> and <code class=" language-php">render</code>. We'll examine each of these methods in detail. The <code class=" language-php">report</code> method is used to log exceptions or send them to an external service like <a href="https://bugsnag.com">Bugsnag</a> or <a href="https://github.com/getsentry/sentry-laravel">Sentry</a>. By default, the <code class=" language-php">report</code> method passes the exception to the base class where the exception is logged. However, you are free to log exceptions however you wish.</p>
