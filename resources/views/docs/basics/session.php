<article>
	...
	<h3>Configuration</h3>
	<p>The session configuration file is stored at <code class=" language-php">config<span class="token operator">/</span>session<span class="token punctuation">.</span>php</code>. Be sure to review the options available to you in this file. By default, Space MVC is configured to use the <code class=" language-php">file</code> session driver, which will work well for many applications. In production applications, you may consider using the <code class=" language-php">memcached</code> or <code class=" language-php">redis</code> drivers for even faster session performance.</p>
	<p>The session <code class=" language-php">driver</code> configuration option defines where session data will be stored for each request. Space MVC ships with several great drivers out of the box:</p>
...
<span class="token variable">$request</span><span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">session<span class="token punctuation">(</span></span><span class="token punctuation">)</span><span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">flush<span class="token punctuation">(</span></span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
	...
	<p>Space MVC automatically regenerates the session ID during authentication if you are using the built-in <code class=" language-php">LoginController</code>; however, if you need to manually regenerate the session ID, you may use the <code class=" language-php">regenerate</code> method.</p>
