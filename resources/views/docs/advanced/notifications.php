...
<span class="token punctuation">{</span>
   ...
   <span class="token comment" spellcheck="true"> // ...
	...
	<p>Once the <code class=" language-php">ShouldQueue</code> interface has been added to your notification, you may send the notification like normal. Space MVC will detect the <code class=" language-php">ShouldQueue</code> interface on the class and automatically queue the delivery of the notification:</p>
...
<span class="token punctuation">}</span></code></pre>
	...
	<pre class=" language-php"><code class=" language-php">php artisan vendor<span class="token punctuation">:</span>publish <span class="token operator">--</span>tag<span class="token operator">=</span>Space MVC<span class="token operator">-</span>notifications</code></pre>
...
@endcomponent</code></pre>
	...
	<p>You may export all of the Markdown notification components to your own application for customization. To export the components, use the <code class=" language-php">vendor<span class="token punctuation">:</span>publish</code> Artisan command to publish the <code class=" language-php">Space MVC<span class="token operator">-</span>mail</code> asset tag:</p>
...
<span class="token punctuation">}</span></code></pre>
	...
	<p>Once notifications are stored in the database, you need a convenient way to access them from your notifiable entities. The <code class=" language-php">Illuminate\<span class="token package">Notifications<span class="token punctuation">\</span>Notifiable</span></code> trait, which is included on Space MVC's default <code class=" language-php">App\<span class="token package">User</span></code> model, includes a <code class=" language-php">notifications</code> Eloquent relationship that returns the notifications for the entity. To fetch notifications, you may access this method like any other Eloquent relationship. By default, notifications will be sorted by the <code class=" language-php">created_at</code> timestamp:</p>
...
<span class="token punctuation">{</span>
    <span class="token keyword">return</span> <span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name">SlackMessage</span><span class="token punctuation">)</span>
                <span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">from<span class="token punctuation">(</span></span><span class="token string">'Space MVC'</span><span class="token punctuation">)</span>
                <span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">image<span class="token punctuation">(</span></span><span class="token string">'https://Space MVC.com/favicon.png'</span><span class="token punctuation">)</span>
                <span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">content<span class="token punctuation">(</span></span><span class="token string">'This will display the Space MVC logo next to the message'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span></code></pre>
...
<span class="token punctuation">}</span></code></pre>
	...
	<p>Sometimes, applications store each user's preferred locale. By implementing the <code class=" language-php">HasLocalePreference</code> contract on your notifiable model, you may instruct Space MVC to use this stored locale when sending a notification:</p>
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span></code></pre>
	<p>Once you have implemented the interface, Space MVC will automatically use the preferred locale when sending notifications and mailables to the model. Therefore, there is no need to call the <code class=" language-php">locale</code> method when using this interface:</p>
	<pre class=" language-php"><code class=" language-php"><span class="token variable">$user</span><span class="token operator">-</span><span class="token operator">&gt;</span><span class="token function">notify<span class="token punctuation">(</span></span><span class="token keyword">new</span> <span class="token class-name">InvoicePaid</span><span class="token punctuation">(</span><span class="token variable">$invoice</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
...
<span class="token punctuation">{</span>
   <span class="token comment" spellcheck="true"> // $event-&gt;channel
	...
	<p>Space MVC ships with a handful of notification channels, but you may want to write your own drivers to deliver notifications via other channels. Space MVC makes it simple. To get started, define a class that contains a <code class=" language-php">send</code> method. The method should receive two arguments: a <code class=" language-php"><span class="token variable">$notifiable</span></code> and a <code class=" language-php"><span class="token variable">$notification</span></code>:</p>
	<pre class=" language-php"><code class=" language-php"><span class="token delimiter">&lt;?php</span>
