<!-- https://opensourceforu.com/2015/12/the-basics-of-mvc-architecture-in-php/ -->

<article>
	<h2>What is Space MVC Framework</h2>
	<p>
		The Space MVC PHP Framework is the fastest and most lightweight high performance, scalable, advanced PHP 7+
	...
	<p>
		...
		DB data (if required) and puts it into HTML tags. Once the interpreter completes its tasks, it sends the result
	...
	<p>
		...
		involved in software development evolved in the late 1980s. Its a software
		architecture built on the idea that the logic of an application should be separated from its presentation.
		A system developed on the MVC architecture should allow a front-end developer and a back-end developer to work
	...
	<p>
		...
		doesnt matter to the Model component what happens to the data when it is passed to the View or Controller
		components.
	</p>
	...
	<p>
		...
		An example of this is a link generated by the View component, when a user clicks and an action gets triggered
		in the Controller.
	</p>
	...
	<p>
		...
		which happen through the View component.
	</p>
</article>
