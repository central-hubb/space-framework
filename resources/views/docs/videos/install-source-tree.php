...
<p>In short Git is used to backup a copy of your website code online in its original source code state. You can setup git
	use private repositories or public repositories to store you data
</p>

<p>A Private repository will allow for only users you choose to download and develop on your code</p>
<p>A Public Repository will allow the general public to view and download your code</p>
<p>The main benefit of using git is that multiple developers can work on the same project at the same time and they will pull and push code to and from git</p>
<p>Git acts as a centralized location for your code so you can develop as a team more easily</p>

<h1>What is source tree?</h1>
...
<h1>How to install source tree?</h1>
...
<p><a href="/docs/videos/github-multiple-users">Next Video Tutorial : 4) How do multiple developers use git?</a></p>
