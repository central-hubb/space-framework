<article>
    ...
    <h4>Apache</h4>
    <p>Laravel includes a <code class=" language-php"><span class="token keyword">public</span><span
        ...
        used to provide URLs without the <code class=" language-php">index<span
                    class="token punctuation">.</span>php</code> front controller in the path. Before serving Laravel
    ...
    <p>If the <code class=" language-php"><span class="token punctuation">.</span>htaccess</code> file that ships with
        Laravel does not work with your Apache installation, try this alternative:</p>
