        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <ul class="list-unstyled task-list">
                    ...
                    <li>
                        <p>Data Duplication Check <span class="label-percent">90%</span></p>
                ...
                <div class="table-responsive">
                    <table class="table table-minimal table-fullwidth table-striped">
                        ...
                        <tr>
                            ...
                            <td>Steve</td>
                            <td>$122</td>
                            <td>Oct 21, 2016 &nbsp;&nbsp;<span class="text-muted">10:23 AM</span></td>
                        ...
                        <tr>
                            ...
                            <td>Amber</td>
                            <td>$62</td>
                            <td>Oct 21, 2016 &nbsp;&nbsp;<span class="text-muted">10:18 AM</span></td>
                        ...
                        <tr>
                            ...
                            <td>Michael</td>
                            <td>$34</td>
                            <td>Oct 18, 2016 &nbsp;&nbsp;<span class="text-muted">09:22 AM</span></td>
                        ...
                        <tr>
                            ...
                            <td>Roger</td>
                            <td>$186</td>
                            <td>Oct 17, 2016 &nbsp;&nbsp;<span class="text-muted">08:47 AM</span></td>
                            <td><span class="label label-success">COMPLETED</span></td>
                        </tr>
                        <tr>
                            ...
                            <td>Smith</td>
                            <td>$362</td>
                            <td>Oct 16, 2016 &nbsp;&nbsp;<span class="text-muted">11:18 PM</span></td>
                            <td><span class="label label-success">COMPLETED</span></td>
                        </tr>
                        <tr>
                            <td><a href="#">763651</a></td>
                            <td>Claudia</td>
                            <td>$112</td>
                            <td>Oct 15, 2016 &nbsp;&nbsp;<span class="text-muted">10:08 PM</span></td>
                            <td><span class="label label-success">COMPLETED</span></td>
                        </tr>
                        <tr>
                            <td><a href="#">763650</a></td>
                            <td>Simon</td>
                            <td>$285</td>
                            <td>Oct 15, 2016 &nbsp;&nbsp;<span class="text-muted">09:42 PM</span></td>
                            <td><span class="label label-warning">PENDING</span></td>
                        </tr>
                        </tbody>
                    </table>
    ...
    <div class="col-md-7">
            ...
            <div class="col-md-6">
                <div class="widget widget-task-progress">
                    <div class="top clearfix">
                        <span class="title">Review Final Design</span> <span class="percentage">85%</span>
                    </div>
                ...
                <div class="widget widget-mini-realtime-usage">
                    ...
                    <div class="usage-info clearfix">
                        ...
                        <div class="right">
                            ...
                            <span class="value"><span class="number">19.30</span> GB</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="widget widget-system-load">
            <div id="load-chart" class="chart easy-pie-chart" data-percent="70">
                <span class="percent"><span class="number">70</span>%</span>
            </div>
            <div class="info">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        ...
                        <span class="value"><span class="number">45</span>%</span>
                    </div>
                    <div class="col-xs-4">
                        <span class="title">AVERAGE</span>
                        <span class="value"><span class="number">73</span>%</span>
                    </div>
                    <div class="col-xs-4">
                        <span class="title">HIGH</span>
                        <span class="value"><span class="number">95</span>%</span>
                    </div>
                </div>
                <div class="controls">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="following">
                            <ul class="list-unstyled list-positions">
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/male1.png" class="user-picture" alt="">
                                ...
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/female1.png" class="user-picture" alt="">
                                ...
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/male2.png" class="user-picture" alt="">
                                ...
                                <li class="position down clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/female2.png" class="user-picture" alt="">
                                ...
                                <li class="position down clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/female3.png" class="user-picture" alt="">
                        ...
                        <div role="tabpanel" class="tab-pane" id="global">
                            <ul class="list-unstyled list-positions">
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/male3.png" class="user-picture" alt="">
                                            <span class="position-number">1</span>
                                        </div>
                                        <div class="right">
                                ...
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/female4.png" class="user-picture" alt="">
                                            <span class="position-number">2</span>
                                        </div>
                                        <div class="right">
                                ...
                                <li class="position up clearfix">
                                    ...
                                    <div class="account">
                                        <div class="user">
                                            <img src="/themes/default/assets/img/people/male4.png" class="user-picture" alt="">
                                            <span class="position-number">3</span>
                                        </div>
                                        <div class="right">
        ...
        <div class="panel panel-scrolling">
            ...
            <div class="panel-body">
                <ul class="list-unstyled list-contacts">
                    <li>
                        <div class="media">
                            <img src="/themes/default/assets/img/people/female3.png" class="picture" alt="">
                    ...
                    <li>
                        <div class="media">
                            <img src="/themes/default/assets/img/people/male1.png" class="picture" alt="">
                            <span class="status online"></span>
                        </div>
                        <div class="info">
                    ...
                    <li>
                        <div class="media">
                            <img src="/themes/default/assets/img/people/female4.png" class="picture" alt="">
                            <span class="status"></span>
                        </div>
                        <div class="info">
                    ...
                    <li>
                        <div class="media">
                            <img src="/themes/default/assets/img/people/female5.png" class="picture" alt="">
                            <span class="status online"></span>
                        </div>
                        <div class="info">
        ...
        <div class="panel panel-scrolling">
            ...
            <div class="panel-body">
                <ul class="list-unstyled activity-list">
                    <li>
                        <img src="/themes/default/assets/img/user1.png" alt="Avatar" class="img-circle pull-left avatar">
                        <p><a href="#">Michael</a> has achieved 80% of his completed tasks <span class="timestamp">20 minutes ago</span></p>
                    </li>
                    <li>
                        <img src="/themes/default/assets/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
                        <p><a href="#">Daniel</a> has been added as a team member to project <a href="#">System Update</a> <span class="timestamp">Yesterday</span></p>
                    </li>
                    <li>
                        <img src="/themes/default/assets/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
                        <p><a href="#">Martha</a> created a new heatmap view <a href="#">Landing Page</a> <span class="timestamp">2 days ago</span></p>
                    </li>
                    <li>
                        <img src="/themes/default/assets/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
                        <p><a href="#">Jane</a> has completed all of the tasks <span class="timestamp">2 days ago</span></p>
                    </li>
                    <li>
                        <img src="/themes/default/assets/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
