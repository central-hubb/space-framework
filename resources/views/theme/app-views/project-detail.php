					...
					<div class="col-md-9">
						<div class="media">
							<div class="media-left">
								<img src="/themes/default/assets/img/project-logo.png" class="project-logo" alt="Project Logo">
							</div>
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a href="#collapse1" data-toggle="collapse" data-parent="#accordion">
										<span class="milestone-title"><i class="fa fa-check icon-indicator text-success"></i> Research on eCommerce Trends</span> <span class="label label-success label-transparent">PAID</span> 
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a href="#collapse2" data-toggle="collapse" data-parent="#accordion" class="collapsed">
										<span class="milestone-title"><i class="fa fa-check icon-indicator text-success"></i> Business Requirements</span> <span class="label label-danger label-transparent">DUE</span>
