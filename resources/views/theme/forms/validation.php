		...
		<div class="panel">
			...
			<div class="panel-body">
				<form id="basic-form" method="post" novalidate>
					...
					<div class="form-group">
						<label class="control-label">Radio Button</label><br />
					...
					<div class="form-group">
						<label class="control-label" for="food">Multiselect</label><br/>
		...
		<div class="panel">
			...
			<div class="panel-body">
				<form id="advanced-form" data-parsley-validate novalidate>
					...
					<div class="form-group">
						<label class="control-label">Select Min. 2 Options</label><br />
					...
					<div class="form-group">
						<label class="control-label">Select Between 1-2 Options</label><br />
						<label class="control-inline fancy-checkbox">
