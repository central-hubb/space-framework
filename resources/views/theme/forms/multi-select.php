	...
	<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				...
				<label>"Select All" Option Enabled</label><br>
				...
				<label>Custom Button Class (btn-primary)</label><br>
			...
			<div class="col-md-6">
				<label>Custom Checkbox</label><br>
				...
				<label>Disabled Options</label><br>
				...
				<label>Custom Button Class (btn-success)</label><br>
