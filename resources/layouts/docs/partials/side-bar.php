...
<p>
    <ul>
        <li><a href="#" style="color:#5A5A5A;text-decoration: none;">Introduction</a>
            <ul>
        ...
        <li><a href="#" style="color:#5A5A5A;text-decoration: none;">Security</a>
            <ul>
                ...
                <li><a href="/docs/advanced/asset">Clients</a></li>
                <li><a href="/docs/advanced/asset">ACL</a></li>
                <li><a href="/docs/advanced/asset">Authorization</a></li>
                <li><a href="/docs/advanced/asset">Authentication</a></li>
                <li><a href="/docs/advanced/asset">Permissions</a></li>
                <li><a href="/docs/advanced/asset">Permission Groups</a></li>
            </ul>
        </li>
